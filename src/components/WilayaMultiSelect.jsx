...
export default function WilayaMultiSelect({
  ...
  return (
    <FormField label={label} icon={FiMap} hint={hint}>
      <div className="space-y-3 rounded-2xl border border-slate-200 bg-white/80 p-4 dark:border-slate-700 dark:bg-slate-900/60">
        ...
        <div className="max-h-64 space-y-2 overflow-y-auto rounded-2xl border border-slate-200 bg-slate-50/80 p-3 dark:border-slate-800 dark:bg-slate-950/40">
          {loading ? (
